...
public class EnemyControlScript : MonoBehaviour
{
    ...
    [SerializeField]
    private GameObject _Hand_L;

    [SerializeField]
    private GameObject _Hand_R;
    ...
    private static readonly int AttackChargeState = Animator.StringToHash(
        "Base Layer.attack_charge"
    );
    ...
    private static readonly int CatchSuccessState = Animator.StringToHash(
        "Base Layer.catch_success"
    );
    private static readonly int CatchSuccessBackState = Animator.StringToHash(
        "Base Layer.catch_success_back"
    );
    private static readonly int CatchMissState = Animator.StringToHash("Base Layer.catch_miss");
    private static readonly int CatchMissBackState = Animator.StringToHash(
        "Base Layer.catch_miss_back"
    );
    ...
    private static readonly int Telekinesis1State = Animator.StringToHash(
        "Base Layer.telekinesis1"
    );
    private static readonly int Telekinesis2State = Animator.StringToHash(
        "Base Layer.telekinesis2"
    );
            ...
            if (_Animator.GetFloat(CatchParameter) == 0)
            {
                ...
                else if (!Input.GetKey(KeyCode.LeftShift) && !Input.GetKey(KeyCode.RightShift))
                {
                    ...
                    if (_WithinRange)
                    {
                        ...
                        _Target.transform.rotation = Quaternion.LookRotation(
                ...
                _Animator.GetFloat(CatchParameter) > 0
            ...
            )
            {
                ...
                else if (_Animator.GetFloat(CatchParameter) == 2)
                {
                    ...
                    _Target.transform.rotation =
                        _Hand_L.transform.rotation * Quaternion.Euler(180, 0, 270);
                }
            }
        }
